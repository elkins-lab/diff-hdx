...
def test_intrinsic_rates_neighbor_sensitivity():
    """
    ...
    assert rates_ile[1] < rates_ala[1], (
        "Right-neighbour Ile should reduce k_int relative to Ala"
    )
...
def test_sasa_probe_radius_effect():
    """
...
def test_intrinsic_rates_left_neighbor_sensitivity():
    """
...
def test_intrinsic_rates_c_terminal_boundary():
    """
...
def test_intrinsic_rates_jit_compatible():
    """
...
def test_intrinsic_rates_temperature_dependence():
    """
...
def test_h_bond_energy_far_acceptor():
    """
